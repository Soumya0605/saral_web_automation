Feature: Testing data entry for vidhansabha level karyakarta
Background:
Given user logged in into the saral application
|Email|state.adminup@gmail.com|
|Password|Abc@1234|
|Otp|010203|
Scenario: Testing vidhansabha karyakarta add data and edit entry functionality
...
|Input Fields                   |Input Data                           |
|Name                           |vidhansabha Karyakarta Automation    |
|Father Name                    |testautomation                |
|Designation                    |Vice President                |
|Phone Number                   |8111112434                    |
|Has Smartphone                 |Yes                           |
...
|Category                       |OBC                           |
|Caste                          |Das                           |
|Email                          |vidhansabhakarya@gamil.com    |
|Dob                            |02/Jan/1972                   |
